...
|---|---|---|---|---|---|---|---|---|---|
| ✅ T1 | craftsman | internal/core/config_validate.go, internal/core/config_loader.go, internal/cmd/dispatch.go, internal/core/authority.go, internal/core/driver.go | - | bash -c 'go vet ./... && go test ./internal/core ./internal/cmd -count=1 && ! grep -rn --include=*.go --exclude=*_test.go "func contains" internal/core internal/cmd' | R1.1 | R1.1 | refactor | low | simple |
