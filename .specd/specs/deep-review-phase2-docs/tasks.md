...
|---|---|---|---|---|---|---|---|---|---|
| T1 | craftsman | tools/gendocs/main.go | - | bash -c 'go run ./tools/gendocs -check && go run ./tools/gendocs -check' | R1.1 | R1.1 | feature | low | standard |
| T2 | craftsman | scripts/docs-lint.sh, .github/workflows/ci.yml, CLAUDE.md | T1 | bash -c './scripts/docs-lint.sh && ! test -f docs/CHEATSHEET.md' | R1.2, R1.3 | R1.2, R1.3 | chore | low | simple |
