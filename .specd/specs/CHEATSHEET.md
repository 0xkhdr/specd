# Cheat sheet (canonical copy)

Canonical source of truth is `docs/command-reference.md`'s "Cheat sheet" section.
This file exists so `scripts/docs-lint.sh` can assert the two never drift apart —
edit both together.
