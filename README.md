...
- 🛡️ **Validation Gates**: Programmatic checks (`specd check`) — 18 core gates (EARS syntax, design sections, task schema, acyclic DAG, evidence, sync, context budget, typed intake, and more) plus a separate opt-in security gate.
