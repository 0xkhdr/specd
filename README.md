...
- 🛡️ **Validation Gates**: Programmatic checks (`specd check`) — 26 core gates (EARS syntax, design sections, task schema, acyclic DAG, evidence, sync, context budget, typed intake, governance, memory lint, and more) plus a separate opt-in security gate.
...
- ✅ [Validation Gates](docs/validation-gates.md) — Details on all 26 core validation gates plus security gates.
