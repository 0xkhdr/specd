...
- 🛡️ **Validation Gates**: Programmatic checks (`specd check`) — 19 core gates (EARS syntax, design sections, task schema, acyclic DAG, evidence, sync, context budget, typed intake, governance, and more) plus a separate opt-in security gate.
