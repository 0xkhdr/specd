...
- [x] T1 — `ListResumableSessions` enumerator
...
- [x] T2 — Config `resilience.autoResume` block
...
## Wave 2 — CLI surface
- [x] T3 — `brain resume --list` / `--max-age-minutes`
...
- [x] T4 — `brain resume --session <id>` idempotent continue
...
- [x] T6 — Document host startup contract
...
- [x] T7 — Auto-resume integration test
