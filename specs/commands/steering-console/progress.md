...
| 2 | Editing and bootstrap | T4-T5 | complete | Safe editor/stdin bootstrap supports dry-run and only edits steering Markdown. |
| 3 | Memory and docs | T6-T7 | complete | Memory action plus docs complete. |
