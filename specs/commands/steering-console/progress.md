...
|------|-------|-------|--------|---------------|
| 1 | Root discovery and read views | T1-T3 | pending | `/steer show/status` work from nested dirs and filter canonical files. |
...
- [ ] Missing `.specd/steering` returns 3.
- [ ] Arbitrary path args rejected.
- [ ] Stub detection deterministic.
