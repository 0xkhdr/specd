...
- [ ] **T1 — Map the command schema source of truth**
...
- [ ] **T2 — JSON-RPC 2.0 + MCP envelope structs**
...
- [ ] **T3 — Generate `tools/list` from the command schema**
...
- [ ] **T4 — `tools/call` dispatch into existing handlers**
...
- [ ] **T5 — `specd mcp` command + registry entry**
...
- [ ] **T6 — End-to-end handshake test over a pipe**
...
- [ ] **T7 — Assert tool count parity with help schema + stdlib-only**
...
- [ ] **T8 — Review: no new deps, no LLM/network, invariants intact**
