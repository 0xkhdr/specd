...
func TestRegistryOrder(t *testing.T) {
	...
	want := []string{"task-ids", "dependencies", "dag", "roles", "files", "verify", "evidence", "context-budget", "ears", "approval", "sync", "design", "criteria", "review", "task-trace", "coverage", "evidence-policy", "intake", "governance", "memory-lint", "quality-declaration", "dispatch-parity", "verify-lint", "steering-applicability"}
