...
var refusalRecovery = func() map[string]Refusal {
	...
	for _, code := range []string{
		"ACTOR_ASSURANCE_REQUIRED", "ACTOR_REQUIRED",
		"ARTIFACT_PATH_ABSOLUTE", "AUTHORITY_REQUIRED", "BASELINE_DRIFTED", "BASELINE_UNPINNED", "BASELINE_UNRESOLVABLE",
		"BINDING_MISSING", "BRAIN_ZERO_PROGRESS", "CLARIFICATION_OPEN", "CONFORMANCE_KIND_UNKNOWN",
		"CONFORMANCE_SLUG_REQUIRED", "CONFIG_DIGEST_MISSING", "CURRENT_STATUS_INVALID",
		"DESCENDANT_ACTOR_REQUIRED", "DESCENDANT_ALREADY_RESOLVED", "DESCENDANT_COVERAGE_UNASSIGNED",
		"DESCENDANT_DIGEST_ONLY", "DESCENDANT_EVIDENCE_STALE", "DESCENDANT_NOT_STALE",
		"DESCENDANT_REASON_REQUIRED", "DESCENDANT_REOPEN_ROUTE", "DESCENDANT_RESOLUTION_INVALID",
		"DESCENDANT_RETAIN_UNAPPROVED", "DESCENDANT_REVISION_STALE", "DESCENDANT_STALE_UNRESOLVED",
		"DESCENDANT_SUCCESSOR_REQUIRED", "FLAG_UNKNOWN", "GATE_ID_REQUIRED",
		...
		"HANDSHAKE_MISMATCH", "IMPACT_ACTOR_REQUIRED", "IMPACT_CANDIDATE_DUPLICATE",
		"IMPACT_DEPENDENCY_MISSING", "IMPACT_GRAPH_CYCLIC", "IMPACT_OPERATION_INVALID",
		"IMPACT_REQUEST_INCOMPLETE", "IMPACT_REQUEST_UNKNOWN", "IMPACT_REVISION_INVALID",
		"INPUT_DIGEST_INVALID", "LEASE_SESSION_CONFLICT", "LEASE_SESSION_MISMATCH",
		"MANAGED_TARGET_REQUIRED", "NONCE_REPLAYED", "OUTSIDE_SCOPE", "POLICY_DIGEST_MISSING",
		"RECEIPT_INVALID", "RECEIPT_STALE",
		"REOPEN_ACTOR_REQUIRED", "REOPEN_APPROVALS_INVALID", "REOPEN_ARTIFACT_MOVED",
		"REOPEN_ARTIFACT_UNKNOWN", "REOPEN_ARTIFACT_UNREADABLE", "REOPEN_BASELINE_UNRESOLVABLE",
		"REOPEN_CONSUMED", "REOPEN_CONSUMED_EXTERNALLY", "REOPEN_LEASE_ACTIVE",
		"REOPEN_REASON_REQUIRED", "REOPEN_REVISION_STALE", "REOPEN_SCOPE_AMENDMENT_REQUIRED",
		"REOPEN_SCOPE_INVALID", "REOPEN_TASK_NOT_ELIGIBLE", "REOPEN_TASK_UNKNOWN", "REOPEN_TASKS_INVALID",
		"REQUEST_MODE_CONFLICT", "REQUEST_MODE_INVALID", "ROUTE_DISPATCH_MISSING",
		"ROUTE_HANDOFF_REQUIRED", "SCOPE_AMEND_REFUSED", "SCOPE_AMEND_REASON_REQUIRED",
		"SCOPE_AMEND_ACTOR_REQUIRED", "SCOPE_AMEND_REVISION_STALE", "SCOPE_AMEND_PATH_INVALID",
		"SCOPE_AMEND_TASK_UNKNOWN", "SCOPE_AMEND_TASK_NOT_RUNNING", "SCOPE_AMEND_ALREADY_DECLARED",
		"SESSION_EXPIRED", "SESSION_INVALID", "SESSION_UNKNOWN",
		"SPEC_NOT_DRIVEABLE", "STATE_REVISION_INVALID", "TARGET_INVALID", "TARGET_NOT_SUCCESSOR",
		"TRANSPORT_CAPABILITY_MISSING", "UNDO_CONSUMED", "UNDO_CONSUMED_EXTERNALLY",
		"UNDO_IRREVERSIBLE", "UNDO_LEDGER_EMPTY", "UNDO_NOT_LATEST", "UNDO_NO_PRIOR_STATE",
		"UNDO_REASON_REQUIRED", "UNDO_REVISION_STALE", "UNDO_TARGET_UNKNOWN", "WRITE_SCOPE_CONFLICT",
	} {
